...
with open('/home/ferreiraa/Mestrado/github/Conv1D/CNN/file_lists/train_database_normalized.csv', 'w') as f:
    write = csv.writer(f)
...
with open('/home/ferreiraa/Mestrado/github/Conv1D/CNN/file_lists/test_database_normalized.csv', 'w') as f:
    write = csv.writer(f)
    write.writerow(fields)
