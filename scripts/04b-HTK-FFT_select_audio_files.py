...
train_file_list_path = 'file_lists/normalizados/train_database_norm_full.csv'
devel_file_list_path = 'file_lists/normalizados/test_database_norm_full.csv'
...
counter_train_SampleList.to_csv(NETWORK_ROOT+'file_lists/HTK-FFT/counter_vector_train_norm.csv')  
counter_devel_SampleList.to_csv(NETWORK_ROOT+'file_lists/HTK-FFT/counter_vector_test_norm.csv')
...
test_norm_zip_list = list(zip(sel_filename, sel_class))

print(len(test_norm_zip_list))

fields = ['file', 'class']

with open(NETWORK_ROOT+'file_lists/HTK-FFT/train_database_normalized.csv', 'w') as f:
    write = csv.writer(f)
    write.writerow(fields)
    write.writerows(train_norm_zip_list)

with open(NETWORK_ROOT+'file_lists/HTK-FFT/test_database_normalized.csv', 'w') as f:
    write = csv.writer(f)
    write.writerow(fields)
    write.writerows(test_norm_zip_list)